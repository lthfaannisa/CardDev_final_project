    ...
    <div class="w-full px-6 py-6 mx-auto">
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div class="w-12 h-12 text-center rounded-lg flex items-center justify-center"
            ...
            <div class="w-full max-w-full h-60 px-3 lg:w-full lg:flex-none">
                <div
                    ...
                    <div class="relative h-full overflow-hidden bg-cover rounded-xl"
                        ...
                        <span
                            class="absolute top-0 left-0 w-full h-full bg-center bg-cover bg-gradient-to-tl from-stone-500 to-slate-800 opacity-80"></span>
                        <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                            <h5 class="pt-2 mb-1 px-5 font-bold text-white">SIMBA
                                </p>
                            </h5>
                            <h5 class="mb-6 px-5 font-semibold text-white">Sistem Infomasi Biodata Alumni Universitas Syiah
                                Kuala
                                </p>
                            </h5>
                            <p class="text-white justify-normal px-5">Hi, <span
                                    class="hidden sm:inline">{{ Auth::user()->name }}</span>
                            </p>
                            <p class="text-white justify-normal px-5">This system is developed to track and find out the
                                database of graduates from the Department of Informatics, Faculty of Mathematics and Natural
                                Sciences, Universitas Syiah Kuala. We encourage you to use this system wisely.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            new Chart(canvas, {
                type: 'line',
                data: {
                    labels: ['2015', '2016', '2017', '2018', '2019'], // Label untuk setiap titik pada grafik
                    datasets: [{
                        label: 'Total Alumni',
                        data: data,
                        ...
                        <div class="w-full px-6 mx-auto max-w-screen-2xl rounded-xl">
                            <div class="flex flex-wrap mt-0 -mx-3">
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        <div class="flex items-center justify-center w-10 h-10 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl"
                                            style="background: linear-gradient(to right, #A3A47F, #8FA781)">
                                    ...
                                    <h4 class="font-bold">{{ $categories1 }}</h4>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    ...
                                    <h4 class="font-bold">{{ $categories2 }}</h4>
                                    <div class="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                        <div class="duration-600 ease-soft -mt-0.38 w-3/10 -ml-px flex h-1.5 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all"
                                            role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    ...
                                    <h4 class="font-bold">{{ $categories3 }}</h4>
                                    <div class="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                        <div class="duration-600 ease-soft -mt-0.38 w-2/10 -ml-px flex h-1.5 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all"
                                            role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    ...
                                    <h4 class="font-bold">{{ $categories4 }}</h4>
                                    <div class="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                        <div class="duration-400 ease-soft -mt-0.38 w-1/10 -ml-px flex h-1.5 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all"
                                            role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <script>
                            ...
                            var chart = new Chart(ctx, {
                                ...
                                data: {
                                    ...
                                    datasets: [{
                                        label: 'Jumlah Alumni',
                                        data: [{{ $categories1 }}, {{ $categories2 }}, {{ $categories3 }},
                                            {{ $categories4 }}
                                        ],
