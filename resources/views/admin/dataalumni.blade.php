                                ...
                                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                    <thead class="align-bottom">
                                        <tr>
                                            ...
                                            <th
                                                ...
                                                Tahun Lulus</th>
                                            <th
                                                class="px-6 py-3 w-96 pl-4 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                                Pekerjaan</th>
                                            <th
                                                class="px-6 py-3 w-96 pl-4 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                                Bidang Minat</th>
                                    ...
                                    <tbody>
                                        @foreach ($students as $item)
                                            <tr>
                                                <td class="w-96 pl-4"><img style="width: 70px;"
                                                ...
                                                <td>
                                                    <a href="{{ url('/show', $item->id) }}"
                                                        title="View Student"><button
                                                            class="btn btn-info btn-sm px-1"><i class="fa fa-eye"
                                                                aria-hidden="true"></i>
                                                        </button></a>
                                                </td>
                                                <td>
