                    ...
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        ...
                        <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                            <div class="form-group">
                                <label for="fotoInstansi"><strong class="text-slate-700">Foto Instansi</strong><br>
                                    <div class="mb-2">
                                        <input name="foto_instansi" id="foto_instansi" type="file" class="form-control-file form-control-file border border-gray-300 px-4 py-2 rounded-md" id="fotoInstansi" accept=".png,.jpg, .svg" max-size="300" width="600">
                                    </div>
                        ...
                        <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                            ...
                            <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                                ...
                                <input name="posisi" id='posisi' type="text" class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Posisi" />
                            </div>
                        </li>
                        <li class="relative block px-4 py-2 pt-0 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                            ...
                            <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                                ...
                                <input name="website_instansi" id="website_instansi" type="text" class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Website Instansi" />
                            </div>
                        </li>
                        <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                            ...
                            <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                                ...
                                <input name="email_instansi" id="email_instansi" type="email" class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Email Instansi" />
                            </div>
                        <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                            ...
                            <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                                ...
                                <input name="lokasi_instansi" id="lokasi_instansi" type="text" class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Lokasi Instansi" />
                            </div>
                        </li>
                        <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                            ...
                            <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input p-4" type="radio" name="bidang_minat" id="datamining" value="Data Mining & Kecerdasan Buatan">
                                    <label class="custom-control-label p-2" for="datamining">Data Mining & Kecerdasan
                                        Buatan</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input p-4" type="radio" name="bidang_minat" id="rpl" value="Rekayasa Perangkat Lunak">
                                    <label class="custom-control-label p-2" for="rpl">Rekayasa Perangkat
                                        Lunak</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input p-4" type="radio" name="bidang_minat" id="jaringan" value="Jaringan Komputer & Keamanan Siber">
                                    <label class="custom-control-label p-2" for="jaringan">Jaringan Komputer &
                                        Keamanan Siber</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input p-4" type="radio" name="bidang_minat" id="gis" value="GeoSpasial">
