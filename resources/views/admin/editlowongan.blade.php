                    ...
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        <li
                            ...
                            <div
                                ...
                                <input value="{{ $lowongan->nama_instansi }}" name="nama_instansi" id="nama_instansi"
                                    type="text"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                        ...
                        <li
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $lowongan->foto_instansi }}" name="foto_instansi" id="foto_instansi"
                                    type="file" class="form-control-file" id="fotoInstansi"
                        ...
                        <li
                            ...
                            <div
                                ...
                                <input value="{{ $lowongan->posisi }}" name="posisi" id='posisi' type="text"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                    placeholder="NPM" />
                            </div>
                        </li>
                        ...
                        <li
                            ...
                            <div
                                ...
                                <input value="{{ $lowongan->website_instansi }}" name="website_instansi"
                                    id="website_instansi" type="text"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                    placeholder="Nama Instansi" />
                            </div>
                        ...
                        <li
                            ...
                            <div
                                ...
                                <input value="{{ $lowongan->email_instansi }}" name="email_instansi"
                                    id="email_instansi" type="email"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                        ...
                        <li
                            ...
                            <div
                                ...
                                <input value="{{ $lowongan->lokasi_instansi }}" name="lokasi_instansi"
                                    id="lokasi_instansi" type="text"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                        ...
                        <li
                            ...
                            <div
                                ...
                                <div class="form-check mb-3">
                                    <input value="{{ $lowongan->bidang_minat }}" class="form-check-input p-4"
                        ...
                        <li
                            ...
                            <div
                                ...
                                <textarea value="{{ $lowongan->persyaratan }}" name="persyaratan" id="persyaratan"
