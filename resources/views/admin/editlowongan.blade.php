                    ...
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        ...
                        <li class="relative block px-4 py-2 pt-0 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                            <div class="form-group">
                                ...
                                <input value="{{ $lowongan->foto_instansi }}" name="foto_instansi" id="foto_instansi" type="file" class="form-control-file" id="fotoInstansi" accept=".png,.jpg, .svg" max-size="300" width="600">
                            </div>
                        </li>
