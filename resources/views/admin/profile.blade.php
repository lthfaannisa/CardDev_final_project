      ...
      <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        <nav>
          ...
          <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Lihat</li>
        ...
        <div class="w-full px-6 mx-auto">
            <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl" style="background-image: url('/image/mipa.jpg')">
                <span class="absolute inset-y-0 w-full h-full bg-center bg-cover" style="background: linear-gradient(to top left, #a8a29e,#1e293b); opacity:0.6;"></span>
            </div>
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-none w-auto max-w-full px-3 my-auto">
                        <div class="h-full">
                            ...
                            <p class="mb-0 font-semibold leading-normal text-sm">{{ $student->npm }}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex-auto p-4">
                            ...
                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                <li class="relative block px-4 py-2 pt-0 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                                    ...
                                    <span style="margin-left: 71px;">: {{ $student->nama }}</span>
                                </li>
                                <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                    ...
                                    <span style="margin-left: 154px;">: {{ $student->npm }}</span>
                                </li>
                                <li class="relative block px-4 py-2 pt-0 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                                    <strong class="text-slate-700">Tempat & Tanggal Lahir</strong>
                                    <span style="margin-left: 3px;">: {{ $student->tempat_tanggal_lahir }}</span>
                                </li>
                                <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                    <strong class="text-slate-700">Tahun Masuk, Lulus</strong>
                                    <span style="margin-left: 33px;">: {{ $student->tahun_masuk }}, {{ $student->tahun_lulus }}</span>
                                </li>
                                <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                    <strong class="text-slate-700">Pekerjaan</strong>
                                    <span style="margin-left: 110px;">: {{ $student->pekerjaan }}</span>
                                </li>
                                <li class="relative block px-4 py-2 pt-0 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                                    <strong class="text-slate-700">Bidang Minat</strong>
                                    <span style="margin-left: 85px;">: {{ $student->bidang_minat }}</span>
                                </li>
                                <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                    <strong class="text-slate-700">Judul Tugas Akhir</strong>
                                    <span style="margin-left: 52px;">: {{ $student->judul_tugas_akhir }}, {{ $student->tahun_lulus }}</span>
                                </li>
