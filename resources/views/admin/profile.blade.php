                        ...
                        <div class="flex-auto p-4">
                            ...
                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                <li
                                    ...
                                    <strong class="text-slate-700">Nama Lengkap:</strong> &nbsp; {{ $student->nama }}
                                </li>
                                <li
                                    class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                    <strong class="text-slate-700">NPM:</strong> &nbsp; {{ $student->npm }}
                                </li>
                                <li
                                    class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                ...
                                <li
                                    ...
                                    {{ $student->tahun_masuk }}, {{ $student->tahun_lulus }}
                                </li>
                                <li
                                    class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
