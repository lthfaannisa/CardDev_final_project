            ...
            <div
                ...
                <form action="{{ url('student/simpan') }}" method="post" class="p-4">
                    ...
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        ...
                        <li
                            class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                            <div class="form-group">
                                <label for="fotoAlumni"><strong class="text-slate-700">Foto
                                        Alumni</strong><br></label>
                                <div class="mb-2">
                                    <input name="foto" type="file"
                                        class="form-control-file form-control-file border border-gray-300 px-4 py-2 rounded-md"
                                        id="foto" accept=".png,.jpg,.svg" max-size="300" width="600">
                                </div>
                        ...
                        <li
                            ...
                            <div
                                ...
                                <input name="npm" id="npm" type="text"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                    placeholder="NPM" />
                            </div>
                        ...
                        <li
                            ...
                            <div
                                ...
                                <input name="tempat_tanggal_lahir" id="tempat_tanggal_lahir" type="text"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                            ...
                            <div class="w-1/2 p-0 pr-0">
                                <li
                                    ...
                                    <div
                                        ...
                                        <input name="tahun_lulus" type="number"
                                            class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-full min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                            min="1900" max="2099" step="1"
                        ...
                        <li
                            ...
                            <div
                                ...
                                <input name="pekerjaan" id="pekerjaan" type="text"
                                    class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                        ...
                        <li
                            ...
                            <div
                                ...
                                <textarea name="judul_tugas_akhir" id="judul_tugas_akhir"
