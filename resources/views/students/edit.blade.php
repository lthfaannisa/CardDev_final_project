    ...
    <aside
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <!-- Data Alumni -->
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg bg-white font-semibold text-slate-700" href="/dataalumni">
                    ...
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        <li class="relative block px-4 py-2 pt-0 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                            ...
                            <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                                ...
                                <input value="{{ $student->nama }}" name="nama" id="nama" type="text" class="pl-8.75 text-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 pr-3 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Nama Lengkap" />
                            </div>
                        </li>
                        <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 rounded-t-lg text-sm text-inherit">
                            <div class="form-group">
                                <label for="fotoAlumni"><strong class="text-slate-700">Foto
                                        Alumni</strong><br></label>
                                <div class="mb-2">
                                    <input value="{{ $student->foto }}" name="foto" type="file" class="form-control-file form-control-file border border-gray-300 px-4 py-2 rounded-md" id="foto" accept=".png,.jpg,.svg" max-size="300" width="600">
                                </div>
                        ...
                        <li class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                            ...
                            <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
                                ...
                                <div class="form-check mb-3">
                                    <input value="{{ $student->bidang_minat }}" class="form-check-input p-4" type="radio" name="bidang_minat" id="dataMining">
                                    <label class="custom-control-label p-2" for="dataMining">Data Mining & Kecerdasan
                                        Artfisial</label>
                                </div>
                                <div class="form-check ">
                                    <input value="{{ $student->bidang_minat }}" class="form-check-input p-4" type="radio" name="bidang_minat" id="rpl">
                                    <label class="custom-control-label p-2" for="rpl">Rekayasa Perangkat
                                        Lunak</label>
                                </div>
                                <div class="form-check">
                                    <input value="{{ $student->bidang_minat }}" class="form-check-input p-4" type="radio" name="bidang_minat" id="jaringan">
                                    <label class="custom-control-label p-2" for="jaringan">Jaringan Komputer dan
                                        Keamanan Siber</label>
                                </div>
                                <div class="form-check">
                                    <input value="{{ $student->bidang_minat }}" class="form-check-input p-4" type="radio" name="bidang_minat" id="gis">
